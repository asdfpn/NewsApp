A News Appp created using SwiftUI that connects to a News API to fetch live news. The app uses Combine to handle networking and is build using MVVM pattern.
